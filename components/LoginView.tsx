    ...
    <div className="flex min-h-screen w-full overflow-hidden bg-white">
      ...
      <div className="flex w-full lg:w-1/2 flex-col items-center justify-center px-4 py-12 bg-[#f6f6f8] relative">
        ...
        <div className="w-full max-w-[480px] z-10">
          ...
          <form className="flex flex-col gap-6 mb-8" onSubmit={(e) => { e.preventDefault(); onLogin(); }}>
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#f6f6f8] text-slate-500 font-medium">Or continue with</span>
            </div>
          </div>
