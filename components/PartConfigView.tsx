  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      ...
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-base">
            Material: <strong className="text-slate-900 dark:text-white">ABS (Generic)</strong> <span className="mx-2 text-slate-300">|</span> Density: {state.density} g/cm³
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-4">
          <div className="bg-white dark:bg-slate-800 p-1 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm inline-flex h-10">
            <button className="px-4 h-full rounded flex items-center justify-center text-xs font-semibold bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white shadow-sm transition-all">
              Metric (mm)
            </button>
          ...
          <button className="h-10 px-4 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-white text-sm font-bold shadow-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors flex items-center gap-2">
            <span className="material-symbols-outlined text-[18px]">picture_as_pdf</span>
            Report
          </button>
          <button 
            onClick={onNext}
            className="h-10 px-6 rounded-lg bg-primary hover:bg-blue-600 text-white text-sm font-bold shadow-md shadow-blue-500/20 transition-all flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1 min-h-[600px]">
        {/* Left: Parameters */}
        <div className="lg:col-span-5 flex flex-col gap-5 overflow-y-auto pr-1 custom-scrollbar">
          <div className="bg-white dark:bg-card-dark rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex-1">
            <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-700/50 flex items-center justify-between bg-slate-50/50 dark:bg-slate-800/30 rounded-t-xl">
              <h3 className="font-bold text-slate-900 dark:text-white flex items-center gap-2">
                <span className="material-symbols-outlined text-primary text-[20px]">straighten</span>
                Part Parameters
              </h3>
              <span className="text-xs font-medium text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-800 px-2 py-1 rounded border border-slate-200 dark:border-slate-700">Editable</span>
            </div>
            ...
            <div className="p-5 flex flex-col">
              ...
              <div className="my-3 h-px bg-slate-100 dark:bg-slate-700"></div>
              ...
              <div className="flex items-center justify-between py-2 border-b border-slate-100 dark:border-slate-700/50 bg-blue-50/50 dark:bg-blue-900/10 -mx-2 px-2 rounded">
                <label className="text-sm font-medium text-slate-900 dark:text-slate-100">Density</label>
                <div className="flex items-center bg-white dark:bg-slate-800 border border-blue-200 dark:border-blue-800 rounded-md px-2 focus-within:ring-2 focus-within:ring-primary/20 transition-all">
                  <input 
        ...
        <div className="lg:col-span-7 flex flex-col relative rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-inner group">
          <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10 flex items-center gap-1 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm p-1.5 rounded-lg border border-slate-200 dark:border-slate-700 shadow-lg">
          ...
          <div className="flex-1 w-full h-full relative bg-gradient-to-b from-slate-50 to-slate-200 dark:from-slate-800 dark:to-slate-900 flex items-center justify-center">
          ...
          <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end pointer-events-none">
            <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur px-3 py-1.5 rounded text-xs font-mono text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700">
...
const ParameterInput: React.FC<{ label: string, value: number, unit: string, onChange: (v: number) => void }> = ({ label, value, unit, onChange }) => (
  <div className="flex items-center justify-between py-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0">
    ...
    <div className="flex items-center bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md px-2 focus-within:ring-2 focus-within:ring-primary/20 transition-all">
      <input 
        className="w-24 bg-transparent border-none text-right text-sm font-semibold text-slate-900 dark:text-white p-1 focus:ring-0" 
        type="number" 
        value={value} 
